    ...
    def build_prompt(self, report: AnalysisReport, markdown: str) -> str:
        ...
        return "\n".join(
            [
                ...
                '  "recommendations": [',
                '    {',
                '      "parameter": "rsi_entry_low|rsi_entry_high|rsi_exit_high|anti_chase_pct|stop_loss_pct|soft_sell_min_profit_pct|exit_cooldown_minutes|trail_trigger_pct|trail_stop_pct|ema_trend_period|ema_signal_period|rsi_period|macd_fast|macd_slow|macd_signal_line",',
                '      "current_value": 0,',
